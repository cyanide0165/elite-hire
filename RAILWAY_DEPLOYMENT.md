...
- **Good News**: I have automated this!
- The app will now automatically check and seed the database every time it restarts.
- If you don't see job roles, just wait 1 minute after deployment and refresh the page.
